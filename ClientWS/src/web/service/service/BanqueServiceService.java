 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://service.service.web/", wsdlLocation = "http://localhost:8585/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://service.service.web/", "BanqueServiceService");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://service.service.web/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.service.web/", "BanqueWSPort"), BanqueWS.class, features);
    }
